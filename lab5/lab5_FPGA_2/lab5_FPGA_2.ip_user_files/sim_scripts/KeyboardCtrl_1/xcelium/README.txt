...
#
# Generated by export_simulation on Thu Nov 26 00:43:19 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './KeyboardCtrl_1.sh' script.

./KeyboardCtrl_1.sh -reset_run
...
./KeyboardCtrl_1.sh -noclean_files

For more information on the script, please type './KeyboardCtrl_1.sh -help'.
