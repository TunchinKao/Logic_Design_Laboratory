...
module Comparator_4bits (a, b, f_a_lt_b, f_a_gt_b, f_a_eq_b);
input [4-1:0] a, b;
output [8-1:0] f_a_eq_b;
output [4-1:0] f_a_lt_b, f_a_gt_b;
...
not(f_a_eq_b[7], f_a_eq_b[6], f_a_eq_b[5], f_a_eq_b[4], f_a_eq_b[3], f_a_eq_b[2], f_a_eq_b[1], f_a_eq_b[0], n_a_eq_b);
not(f_a_lt_b[3], f_a_lt_b[2], f_a_lt_b[1], f_a_lt_b[0], n_a_lt_b);  
not(f_a_gt_b[3], f_a_gt_b[2], f_a_gt_b[1], f_a_gt_b[0], n_a_gt_b);  
