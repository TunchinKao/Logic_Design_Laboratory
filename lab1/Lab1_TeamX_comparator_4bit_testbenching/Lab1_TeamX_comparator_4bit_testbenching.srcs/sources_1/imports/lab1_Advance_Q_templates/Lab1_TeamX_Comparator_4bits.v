...
wire [4-1:0] fanout_a_lt_b, fanout_a_gt_b;
wire [8-1:0] fanout_a_eq_b;
...
not(fanout_a_gt_b[3], fanout_a_gt_b[2], fanout_a_gt_b[1], fanout_a_gt_b[0], n_a_lt_b);
not(fanout_a_eq_b[7], fanout_a_eq_b[6], fanout_a_eq_b[5], fanout_a_eq_b[4], fanout_a_eq_b[3], fanout_a_eq_b[2], fanout_a_eq_b[1], fanout_a_eq_b[0], n_a_lt_b);
